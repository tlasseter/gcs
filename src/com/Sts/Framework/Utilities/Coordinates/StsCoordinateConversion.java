...
package com.Sts.Framework.Utilities.Coordinates;

import java.util.*;

public class StsCoordinateConversion
{

  public StsCoordinateConversion()
  {
  ...
  public double[] latLon2UTM(double latitude, double longitude)
  {
